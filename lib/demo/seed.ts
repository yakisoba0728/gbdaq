...
export const SEED_MARKETS: DemoMarket[] = [
  M('m1', 'food-tangsu', '급식', '🍱', '다음 주 급식에 탕수육 나온다?', '급식 식단표 공지 기준으로 정산', 0.73, 92),
  M('m2', 'exam-info-perfect', '시험', '📝', '정보 수행평가 만점자 5명 이상?', '담당 교사 성적 공지 기준', 0.41, 71),
  M('m3', 'dorm-rollcall-10', '기숙사', '🏠', '오늘 기숙사 점호 10시 전에 끝난다?', '기숙사 점호 종료 시각 기준', 0.79, 54),
  M('m4', 'club-festival-band', '동아리', '🎸', '축제 대상은 밴드부가 받는다?', '축제 시상식 결과 기준', 0.64, 48),
  M('m5', 'event-sports-rain', '행사', '🌧️', '체육대회 당일 비 와서 연기된다?', '학교 공지 기준', 0.55, 63),
  M('m6', 'schedule-friday-short', '학사일정', '📅', '이번 주 금요일 단축수업 한다?', '학사일정 공지 기준', 0.88, 32),
  M('m7', 'food-burger', '급식', '🍔', '이번 달 급식에 햄버거 2번 이상 나온다?', '식단표 기준', 0.34, 21),
  M('m8', 'exam-avg-up', '시험', '📈', '2학기 중간 평균, 1학기보다 오른다?', '성적 공지 기준', 0.58, 88),
]
